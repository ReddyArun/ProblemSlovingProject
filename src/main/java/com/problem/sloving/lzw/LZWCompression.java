package com.problem.sloving.lzw;
...
public class LZWCompression {
	...
	public void compress() {
		...
		try {
			string_code = (short) input.read(); /*
												 ...
												 * Assuming it to be 0 - 255*
												 * Hence only valid for ASCII
												 * text files
												 */

			/*
			 * * This is the main loop where it all happens. This loop runs util
			 * all of* the input has been exhausted. Note that it stops adding
			 * codes to the* table after all of the possible codes have been
			 * defined.
			 */
	 ...
	 * returned. If* the string is not found, the first available index in the
